...
{
    public partial class Medicals_list : Form
    {
        public Medicals_list()
        {
            InitializeComponent();
            sqlConnection1.Open();
        ...
        private void edit_button_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                string id_record = selectedRow.Cells["Номер больничного"].Value.ToString();
                ...
                Form frm = new Edit_medical(id_record, date_start, date_end);
                frm.Show();
            }
        }
